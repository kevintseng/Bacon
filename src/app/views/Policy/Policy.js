...
const Policy = ({check, onPressCheckBox,onPressPolicy, onPressRule}) => {
  return(
    <View style={{flexDirection:'row', alignItems: 'center', justifyContent: 'center'}}>
      <TouchableOpacity style={{padding: 3}} onPress={ onPressCheckBox }>
      ...
      <Text style={{fontSize: 12}} onPress={ onPressPolicy }>服務條款</Text>
      <Text style={{color: '#b3b3b3',fontSize: 12}}>及</Text>
      <Text style={{fontSize: 12}} onPress={ onPressRule }>BACON隱私權政策</Text>
    </View>
  )
}
