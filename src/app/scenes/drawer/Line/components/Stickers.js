  ...
  return (
    <ScrollView directionalLockEnabled contentContainerStyle={{width: width - 10, alignItems: "center"}}>
      <View style={{ flexDirection: "row", flexWrap: "wrap", width, marginBottom: 30}}>
            ...
            <TouchableOpacity
              style={styles.sticker}
              onPress={() => handleStickerPressed("https://firebasestorage.googleapis.com/v0/b/bacon-tsao.appspot.com/o/stickers%2Fgirl01.png?alt=media&token=501844c0-724e-404b-b891-882a71622531")}
            >
              <Image
                style={{ width: 80, height: 66}}
            ...
            <TouchableOpacity
              style={styles.sticker}
              onPress={() => handleStickerPressed("https://firebasestorage.googleapis.com/v0/b/bacon-tsao.appspot.com/o/stickers%2Fgirl02.png?alt=media&token=8e712371-9901-4a2e-abb5-bc0c4756b091")}
            >
              <Image
                style={{ width: 80, height: 66}}
            ...
            <TouchableOpacity
              style={styles.sticker}
              onPress={() => handleStickerPressed("https://firebasestorage.googleapis.com/v0/b/bacon-tsao.appspot.com/o/stickers%2Fgirl03.png?alt=media&token=49d7b362-179a-40e5-8877-3d221e1ba8ed")}
            >
              <Image
                style={{ width: 80, height: 66}}
            ...
            <TouchableOpacity
              style={styles.sticker}
              onPress={() => handleStickerPressed("https://firebasestorage.googleapis.com/v0/b/bacon-tsao.appspot.com/o/stickers%2Fgirl04.png?alt=media&token=2c4b9a45-f128-490b-b6ac-a66cf7f48d5b")}
            >
              <Image
                style={{ width: 80, height: 66}}
            ...
            <TouchableOpacity
              style={styles.sticker}
              onPress={() => handleStickerPressed("https://firebasestorage.googleapis.com/v0/b/bacon-tsao.appspot.com/o/stickers%2Fgirl05.png?alt=media&token=812f008e-3975-47d8-b83a-de60a469c666")}
            >
              <Image
                style={{ width: 80, height: 66}}
            ...
            <TouchableOpacity
              style={styles.sticker}
              onPress={() => handleStickerPressed("https://firebasestorage.googleapis.com/v0/b/bacon-tsao.appspot.com/o/stickers%2Fgirl06.png?alt=media&token=ee952470-4bb7-4449-9d5f-5efb9d88ac9b")}
            >
              <Image
                style={{ width: 80, height: 66}}
            ...
            <TouchableOpacity
              style={styles.sticker}
              onPress={() => handleStickerPressed("https://firebasestorage.googleapis.com/v0/b/bacon-tsao.appspot.com/o/stickers%2Fgirl07.png?alt=media&token=64e5426c-51cb-4311-a30c-0169b1bdf2c3")}
            >
              <Image
                style={{ width: 80, height: 66}}
            ...
            <TouchableOpacity
              style={styles.sticker}
              onPress={() => handleStickerPressed("https://firebasestorage.googleapis.com/v0/b/bacon-tsao.appspot.com/o/stickers%2Fgirl08.png?alt=media&token=298a4ea4-1f92-4dee-bf30-2cb0308553fc")}
            >
              <Image
                style={{ width: 80, height: 66}}
            ...
            <TouchableOpacity
              style={styles.sticker}
              onPress={() => handleStickerPressed("https://firebasestorage.googleapis.com/v0/b/bacon-tsao.appspot.com/o/stickers%2Fgirl09.png?alt=media&token=6dbaa74a-b2d0-4fd7-b35b-d23ad00a08ea")}
            >
              <Image
                style={{ width: 80, height: 66}}
            ...
            <TouchableOpacity
              style={styles.sticker}
              onPress={() => handleStickerPressed("https://firebasestorage.googleapis.com/v0/b/bacon-tsao.appspot.com/o/stickers%2Fgirl10.png?alt=media&token=1237083a-11d1-4ebd-980c-41f13fb83647")}
            >
              <Image
                style={{ width: 80, height: 66}}
            ...
            <TouchableOpacity
              style={styles.sticker}
              onPress={() => handleStickerPressed("https://firebasestorage.googleapis.com/v0/b/bacon-tsao.appspot.com/o/stickers%2Fgirl11.png?alt=media&token=8019f951-c85b-42ea-a472-b3ff62d5bc31")}
            >
              <Image
                style={{ width: 80, height: 66}}
            ...
            <TouchableOpacity
              style={styles.sticker}
              onPress={() => handleStickerPressed("https://firebasestorage.googleapis.com/v0/b/bacon-tsao.appspot.com/o/stickers%2Fgirl12.png?alt=media&token=8c2a7d20-39a6-45d5-987c-e181a77758fe")}
            >
              <Image
                style={{ width: 80, height: 66}}
