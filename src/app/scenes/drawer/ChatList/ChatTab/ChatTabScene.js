        ...
        .then(nonHandleChatCounts => {
          ...
          .then(lastMessages => {
            ...
            .then(data => {
              ...
              this.ChatStore.setMatchChatRooms(chatRooms.filter(ele => blockade_ids.indexOf(ele.uid) === -1))
          ...
          nonHandleChatCounts => {
            ...
            .then(lastMessages => {
              ...
              .then(data => {
                ...
                this.ChatStore.setVistorChatRooms(chatRooms.filter(ele => blockade_ids.indexOf(ele.uid) === -1))
      ...
      .then(snap => { 
        ...
        .then(lastMessages => {
          ...
          .then(data => {
            ...
            this.ChatStore.setSendChatRooms(chatRooms.filter(ele => blockade_ids.indexOf(ele.uid) === -1))
