    ...
    render() {
        return (
            <View style={this.state.size}>
                ...
                <FormInput autoFocus={true} autoCorrect={false} placeholder='sample@email.com' returnKeyType={'next'} keyboardType={'email-address'} value={this.state.email} maxLength={60} onChangeText={email => {
                    this.setState({email})
                }} onSubmitEditing={() => {
                    this.checkEmail
                }}/>
                ...
                <View stye={{
                    ...
                    <Button title='還沒有帳號? 建立新帳號' color='black' backgroundColor='transparent' onPress={Actions.signup} />
                    <Button title='忘記密碼?' color='grey' backgroundColor='transparent' onPress={() => alert('忘記密碼')}/>
                </View>
                {/*
